...
return [
    ...
    "UPLOAD_PATH"         => storage_path() . DIRECTORY_SEPARATOR . "app" . DIRECTORY_SEPARATOR . "aetherupload",
    "HEAD_DIR"            => "_head",
    ...
    "GROUPS"              => [ # 分组，可设置多个不同分组，各自拥有独立配置
        "file" => [ # 新增分组请尽量使用video、audio等有意义的分组名
            ...
            "FILE_EXTENSIONS"              => "pdf", # 被允许的资源文件扩展名，空为不限制，多个值以逗号分隔
            ...
            "EVENT_UPLOAD_COMPLETE"        => 'App\Http\Services\InvoiceService::parsePdfInvoice()', # 上传完成后触发的事件（已存文件），Receiver的实例被注入
        ],
